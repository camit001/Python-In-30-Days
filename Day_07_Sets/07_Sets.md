...
```py
locations = {"India", "Mumbai", "Bihar", "Mumbai"}

print(locations)
print("Number of unique locations:", len(locations))
print("Mumbai" in locations)

cities = {"Mumbai", "Delhi", "Bengaluru"}
other_cities = {"Mumbai", "Pune", "Patna"}

print("Union:", cities.union(other_cities))
print("Intersection:", cities.intersection(other_cities))
print("Difference:", cities.difference(other_cities))
```
